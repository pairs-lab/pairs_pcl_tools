...
void PCL2MapRegistration::onInit() {
  ...
  pairs_lib::ParamLoader param_loader(_nh, "PCL2MapRegistration");
...
bool PCL2MapRegistration::callbackSrvRegisterOffline(pairs_pcl_tools::SrvRegisterPointCloudOffline::Request & req,
                                                     pairs_pcl_tools::SrvRegisterPointCloudOffline::Response &res) {
  if (!_is_initialized) {
    res.success = false;
...
bool PCL2MapRegistration::callbackSrvRegisterPointCloud(pairs_pcl_tools::SrvRegisterPointCloudByName::Request & req,
                                                        pairs_pcl_tools::SrvRegisterPointCloudByName::Response &res) {
  if (!_is_initialized) {
    res.success = false;
    res.message = "Registration unitialized.";
    return false;
...
RegistrationOutput PCL2MapRegistration::pcl2map_ndt(RegistrationInput &input) {
  ...
  pairs_lib::ScopeTimer timer = pairs_lib::ScopeTimer("PCL2MapRegistration::pcl2map_ndt", nullptr, false);
...
RegistrationOutput PCL2MapRegistration::pcl2map_fpfh(RegistrationInput &input) {
  ...
  pairs_lib::ScopeTimer timer = pairs_lib::ScopeTimer("PCL2MapRegistration::pcl2map_fpfh", nullptr, false);
...
RegistrationOutput PCL2MapRegistration::pcl2map_gicp(RegistrationInput &input) {
  ...
  pairs_lib::ScopeTimer timer = pairs_lib::ScopeTimer("PCL2MapRegistration::pcl2map_gicp", nullptr, false);
...
RegistrationOutput PCL2MapRegistration::pcl2map_icpn(RegistrationInput &input) {
  ...
  pairs_lib::ScopeTimer timer = pairs_lib::ScopeTimer("PCL2MapRegistration::pcl2map_icpn", nullptr, false);
...
RegistrationOutput PCL2MapRegistration::pcl2map_sicpn(RegistrationInput &input) {
  ...
  pairs_lib::ScopeTimer timer = pairs_lib::ScopeTimer("PCL2MapRegistration::pcl2map_sicpn", nullptr, false);
...
const Eigen::Matrix4f PCL2MapRegistration::translationYawToMatrix(const Eigen::Vector3f &translation, const float yaw) {
  ...
  const Eigen::Matrix3d   rot_mat = pairs_lib::AttitudeConverter(rot_ax);
...
const geometry_msgs::Transform PCL2MapRegistration::matrixToTfTransform(const Eigen::Matrix4f &mat) {
  ...
  tf_msg.rotation      = pairs_lib::AttitudeConverter(mat.block<3, 3>(0, 0).cast<double>());
...
PLUGINLIB_EXPORT_CLASS(pairs_pcl_tools::PCL2MapRegistration, nodelet::Nodelet);
