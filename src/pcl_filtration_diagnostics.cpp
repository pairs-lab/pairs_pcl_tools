...
namespace pairs_pcl_tools
{
  ...
  {
    m_pub_diagnostics_ = m_nh_->create_publisher<pairs_modules_msgs::msg::PclToolsDiagnostics>("~/diagnostics_out", 10);
  }
  /*//}*/

  /*//{ PclFiltrationDiagnostics publish()*/
  void PclFiltrationDiagnostics::publish(const pairs_modules_msgs::msg::PclToolsDiagnostics& msg)
  {
