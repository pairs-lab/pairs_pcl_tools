#include <pairs_pcl_tools/freespace_pointcloud_creator.h>
...
namespace pairs_pcl_tools
{
  ...
  void FreespacePointcloudCreator::onInit()
  {
    ...
    pairs_lib::ParamLoader param_loader(m_nh, "FreespacePointcloudCreator");
    ...
    pairs_lib::SubscribeHandlerOptions shopts(m_nh);
    shopts.no_message_timeout = ros::Duration(5.0);
    pairs_lib::construct_object(m_sub_pc_in, shopts, "pointcloud_in", &FreespacePointcloudCreator::pointcloud_callback, this);
...
PLUGINLIB_EXPORT_CLASS(pairs_pcl_tools::FreespacePointcloudCreator, nodelet::Nodelet);
