...
#include <pairs_pcl_tools/pcl_filtration_dynparamConfig.h>

#include <pairs_pcl_tools/remove_below_ground_filter.h>
...
private:
  ...
  pairs_lib::SubscribeHandler<sensor_msgs::CameraInfo> sh_camera_info;
  pairs_lib::SubscribeHandler<sensor_msgs::Image>      sh_mask;
  pairs_lib::SubscribeHandler<sensor_msgs::Image>      sh_depth;
...
#include <pairs_pcl_tools/impl/sensors.hpp>
...
private:
  ...
  pairs_lib::SubscribeHandler<sensor_msgs::PointCloud2> _sub_lidar3d;
  ...
  typedef pairs_pcl_tools::pcl_filtration_dynparamConfig Config;
  typedef dynamic_reconfigure::Server<Config>          ReconfigureServer;
  boost::shared_ptr<ReconfigureServer>                 reconfigure_server_;
  /* pairs_pcl_tools::pairs_pcl_tools_dynparamConfig         last_drs_config; */

  RemoveBelowGroundFilter _filter_removeBelowGround;

  void callbackReconfigure(pairs_pcl_tools::pcl_filtration_dynparamConfig& config, uint32_t level);
