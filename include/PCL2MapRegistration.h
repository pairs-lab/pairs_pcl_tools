...
#include <pairs_pcl_tools/pcl2map_registration_dynparamConfig.h>
#include <pairs_pcl_tools/SrvRegisterPointCloudByName.h>
#include <pairs_pcl_tools/SrvRegisterPointCloudOffline.h>
...
private:
  ...
  typedef pairs_pcl_tools::pcl2map_registration_dynparamConfig Config;
  ...
  bool callbackSrvRegisterOffline(pairs_pcl_tools::SrvRegisterPointCloudOffline::Request &req, pairs_pcl_tools::SrvRegisterPointCloudOffline::Response &res);
  bool callbackSrvRegisterPointCloud(pairs_pcl_tools::SrvRegisterPointCloudByName::Request &req, pairs_pcl_tools::SrvRegisterPointCloudByName::Response &res);
