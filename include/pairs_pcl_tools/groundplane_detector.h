...
public:
  struct groundplane_detection_config_t
  {
    ...
    groundplane_detection_config_t(pairs_lib::ParamLoader& pl, const std::string& param_prefix);
    void loadParams(pairs_lib::ParamLoader& pl, const std::string& param_prefix);
  } m_cfg;

  void initialize(ros::NodeHandle& nh, const std::shared_ptr<pairs_lib::Transformer>& tfr, const groundplane_detection_config_t& cfg);
...
#include <pairs_pcl_tools/impl/groundplane_detector.hpp>
