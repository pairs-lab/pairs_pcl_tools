...
std::tuple<bool, std::size_t> pairs_pcl_tools::getFieldOffset(const std::string& field_name)
{
...
T pairs_pcl_tools::getFieldValue(const pt_t& point, std::size_t field_offset)
{
