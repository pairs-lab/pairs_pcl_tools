...
#include <pairs_pcl_tools/common_includes_and_typedefs.h>
...
private:
  ...
  std::shared_ptr<pairs_lib::Transformer> transformer = nullptr;

  bool   keep_organized = false;
  double plane_offset   = 1.0;  // metres
};

#include <pairs_pcl_tools/impl/remove_below_ground_filter.hpp>
