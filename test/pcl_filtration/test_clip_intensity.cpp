...
TEST(IntensityClipping, checkIntensityField)
{
  auto [range_exists1, range_offset1] = pairs_pcl_tools::getFieldOffset<pcl::PointXYZI>("intensity");
  ASSERT_TRUE(range_exists1);

  auto [range_exists2, range_offset2] = pairs_pcl_tools::getFieldOffset<pcl::PointXYZ>("intensity");
