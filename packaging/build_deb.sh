...
# dependency .debs from /prebuilt, then builds pairs_pcl_tools and copies the .deb to /output.
...
LOCAL_RULES="/src/pairs_pcl_tools/packaging/rosdep/pairs.yaml"
